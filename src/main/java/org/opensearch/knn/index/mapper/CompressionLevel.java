...
public enum CompressionLevel {
    ...
    x8(8, "8x", RescoreContext.builder().oversampleFactor(2.0f).build(), Set.of(Mode.ON_DISK)),
    x16(16, "16x", RescoreContext.builder().oversampleFactor(3.0f).build(), Set.of(Mode.ON_DISK)),
    x32(32, "32x", RescoreContext.builder().oversampleFactor(3.0f).build(), Set.of(Mode.ON_DISK));
