...
public class KNN990DerivedSourceStoredFieldsWriter extends StoredFieldsWriter {
     ...
     */
    public KNN990DerivedSourceStoredFieldsWriter(StoredFieldsWriter delegate, List<String> vectorFieldTypesArg) {
    ...
    public int merge(MergeState mergeState) throws IOException {
        ...
        for (int i = 0; i < mergeState.storedFieldsReaders.length; i++) {
            mergeState.storedFieldsReaders[i] = KNN990DerivedSourceStoredFieldsReader.wrapForMerge(mergeState.storedFieldsReaders[i]);
        }
