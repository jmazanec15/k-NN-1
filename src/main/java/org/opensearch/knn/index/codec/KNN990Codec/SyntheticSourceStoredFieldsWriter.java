...
public class SyntheticSourceStoredFieldsWriter extends StoredFieldsWriter {
    ...
    public int merge(MergeState mergeState) throws IOException {
        ...
        for (int i = 0; i < mergeState.storedFieldsReaders.length; i++) {
            mergeState.storedFieldsReaders[i] = SyntheticSourceStoredFieldsReader.wrapForMerge(mergeState.storedFieldsReaders[i]);
        }
