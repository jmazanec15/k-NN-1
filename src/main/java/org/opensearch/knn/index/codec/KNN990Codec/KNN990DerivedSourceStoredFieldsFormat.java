...
@AllArgsConstructor
public class KNN990DerivedSourceStoredFieldsFormat extends StoredFieldsFormat {
    ...
    public StoredFieldsWriter fieldsWriter(Directory directory, SegmentInfo segmentInfo, IOContext ioContext) throws IOException {
        ...
        return new KNN990DerivedSourceStoredFieldsWriter(delegateWriter, vectorFieldTypes);
    }
}
