...
public class KNN990Codec extends FilterCodec {
     ...
     */
    @Builder
    protected KNN990Codec(Codec delegate, PerFieldKnnVectorsFormat knnVectorsFormat, MapperService mapperService) {
    ...
    private StoredFieldsFormat getStoredFieldsFormat() {
        ...
        return new KNN990DerivedSourceStoredFieldsFormat(delegate.storedFieldsFormat(), derivedSourceReadersSupplier, mapperService);
    }
}
