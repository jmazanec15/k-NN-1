...
public interface NativeMemoryAllocation {
    ...
    class IndexAllocation implements NativeMemoryAllocation {
        ...
        private final SharedModelContext sharedModelContext; // TODO: Potentially switch to model pointer
         ...
         * @param openSearchIndexName Name of OpenSearch index this index is associated with
         * @param watcherHandle Handle for watching index file
         * @param sharedModelContext Shared model context
         */
        IndexAllocation(
            ExecutorService executorService,
            long memoryAddress,
            ...
            this.sharedModelContext = sharedModelContext;
        }
        ...
        private void cleanup() {
            ...
            if (sharedModelContext != null) {
                SharedModelStateManager.getInstance().release(sharedModelContext);
            }
        }
